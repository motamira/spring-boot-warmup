 ...
 */
@Component
@Profile(Constants.DEV_INVALID_DATA_PROFILE)
public class UserRegistrationNotValidProducer {
    ...
    public void generateInvalidUserDTO() {
        ...
        userDTO.getPersonalDetailsDTO().setFirstName(Constants.EMPTY_STRING);
    }
