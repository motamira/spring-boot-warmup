...
public class AmqpBindingConfiguration {
    ...
    @Bean
    public ConsumerListener consumerListener(RestConsumer restConsumer) {
        return new ConsumerListener(restConsumer);
    }

    @Bean
    public Producer producer(RabbitTemplate rabbitTemplate, TopicExchange topicExchange) {
        return new Producer(rabbitTemplate, topicExchange);
    }
}
